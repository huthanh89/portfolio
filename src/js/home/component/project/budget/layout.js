    ...
    return (
      <div className='row'>
          <div className='col-lg-12  mb-2'>  
            ...
            <a className="btn btn-info mr-2" href="http://cloudresume.net/budgetid/" target="_blank"> 
              Website
            </a>
            <a className="btn btn-secondary" href="https://github.com/huthanh89/budget" target="_blank"> 
              Code
            </a> 
          </div>     
